...
import com.dthor.torrent.TorrentDoc;
...
public class LuceneServer {
    ...
    public String search(String query) throws IOException, ParseException, InterruptedException {
        ...
        QueryParser titleParser = new QueryParser(Version.LATEST, "title", analyzer);
        QueryParser fileParser = new QueryParser(Version.LATEST, "files", analyzer);
